...
public class TalkContentDao extends CommonDao<TalkContent> implements ITalkContentDao {
	...
	return this.queryList(HQLGenerator.generateGet10ContentByAccountsAndID(account, otherAccount, id));
    }

    @Override
    public List<TalkContent> getTenContentByAccounts(Account account, Account otherAccount, TimeInterval timeInterval,
	    int id) {
	return this.queryList(HQLGenerator.generateGet10ContentByAccountAndIDAndTime(account, otherAccount, id, timeInterval));
    }
